...
```ts
/**
 * Делает все свойства T доступными только для чтения, кроме тех, чьи ключи указаны в K. Преобразование неглубокое.
...
```ts
/**
 * Делает все свойства T доступными только для чтения, кроме тех, чьи ключи указаны в K. Преобразование глубокое.
 * @template T Исходный объект
 * @template K Ключи свойств объектов, которые не будут помечены модификатором readonly
 */
